...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function() {
    ...
    })) : f ? "1" === f && (location.href = "../../../../../taotao-rest/src/main/webapp") : e.test(b) && !d.test(b) ? (createCookie("goToMobile", "1", 10, "/;domain=www.jd.com"), location.href = "../../../../../taotao-rest/src/main/webapp") : createCookie("goToMobile", "0", 10, "/;domain=www.jd.com")
};
var CookieUtil = {};
